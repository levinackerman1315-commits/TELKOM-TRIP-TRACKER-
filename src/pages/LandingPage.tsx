...
//               className="ml-2 px-4 py-2 bg-white text-red-600 rounded-md font-semibold hover:bg-white/90"
//             >
//               Login
//             </button>
//           </nav>
...
//             <a href="#terms" onClick={(e) => scrollToId(e, "terms")} className="text-gray-600 hover:text-gray-900">
//               Syarat & Ketentuan
//             </a>
//             <button
//               onClick={() => navigate("/login")}
