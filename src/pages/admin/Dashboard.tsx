...
export default function FinanceAreaDashboard() {
  ...
  // ✅ NEW: Initial Loading Screen - ONLY THIS IS ADDED
  if (isLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="flex flex-col items-center gap-4">
          <div className="relative">
            ...
            <div className="animate-spin rounded-full h-20 w-20 border-4 border-t-red-600 border-r-transparent border-b-transparent border-l-transparent absolute top-0 left-0"></div>
          </div>
          <div className="text-center">
            <p className="text-xl font-bold text-gray-800">Loading Finance Area Dashboard</p>
...
<div className="flex gap-2 justify-end pt-4 border-t">
              ...
              {/* Pagination Controls for Ongoing Trips */}
              {ongoingTotalPages > 1 && (
                <div className="flex items-center justify-between pt-4 border-t">
                  <Button
                    variant="outline"
