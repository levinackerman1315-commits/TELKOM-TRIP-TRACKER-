...
//   const [formData, setFormData] = useState({
//     category: '',
//     customCategory: '', // ✅ NEW: Custom category untuk "Other"
//     amount: '',
//     merchant_name: '',
//     receipt_date: new Date().toISOString().split('T')[0],
//     description: ''
...
//     const file = e.target.files?.[0]
//     if (file) {
//       // ✅ UPDATED: Remove GIF, only JPG, PNG, PDF
...
//       // ✅ NEW: Use custom category if "other" selected
...
//         {/* ✅ NEW: Upload Instructions Info Box */}
//         <Alert className="mb-6 bg-blue-50 border-blue-200">
//           <Info className="h-4 w-4 text-blue-600" />
//           <AlertDescription>
//             <p className="font-semibold text-blue-900 mb-2">📝 Upload Instructions:</p>
//             <ul className="space-y-1 text-sm text-blue-700">
//               <li>• <strong>Upload receipts one by one</strong> for better tracking and organization</li>
//               <li>• You can upload <strong>multiple receipts separately</strong> during your trip</li>
//               <li>• Supported formats: <strong>JPG, PNG, PDF only</strong> (max 5MB per file)</li>
//               <li>• Make sure receipts are clear and readable before uploading</li>
//             </ul>
//           </AlertDescription>
//         </Alert>
...
//         {/* Form - Using div instead of form element */}
//         <div>
//           <Card className="shadow-soft mb-6">
//             <CardHeader>
//               <CardTitle>Receipt Details</CardTitle>
...
//               {/* ✅ NEW: Custom Category Input (shown when "Other" selected) */}
...
//                     onChange={handleChange}
//                     placeholder="e.g., Equipment Rental, Parking Fee, etc."
//                     disabled={isLoading}
...
//                   )}
//                   <p className="text-xs text-muted-foreground">
//                     Please specify what type of expense this is
//                   </p>
//                 </div>
//               )}
...
//               <li>• Upload within the trip duration period</li>
//               <li>• Finance will verify all receipts before settlement</li>
//               <li>• You can upload multiple receipts - one at a time for better tracking</li>
//             </ul>
//           </AlertDescription>
//         </Alert>
//       </div>
      ...
      <div className="container max-w-4xl mx-auto px-4 py-8">
        ...
        <Card className="mb-6 shadow-soft bg-primary/5 border-primary/20">
          ...
          <CardContent className="space-y-3">
            ...
            {/* ✅ NEW: Show approved advance info */}
            <div className="flex items-center justify-between">
        ...
        {/* ✅ NEW: Payment Method Notice - Show if no approved advance */}
        {(!trip.total_advance || trip.total_advance === 0) && (
          <Alert className="mb-6 bg-yellow-50 border-yellow-200">
            <Info className="h-4 w-4 text-yellow-600" />
            <AlertDescription>
              <p className="font-semibold text-yellow-900 mb-2">💡 Payment Method Notice:</p>
              <p className="text-sm text-yellow-800">
                You haven't received any approved advance for this trip. All expenses will be <strong>reimbursed</strong> after Finance approval.
              </p>
              <p className="text-xs text-yellow-700 mt-2">
                💰 Make sure to keep all receipts and upload them after your trip ends.
              </p>
            </AlertDescription>
          </Alert>
        )}

        {/* ✅ NEW: Advance Balance Warning - Show if advance exists but running low */}
        {trip.total_advance > 0 && trip.total_expenses > 0 && (trip.total_advance - trip.total_expenses) < (trip.total_advance * 0.2) && (
          <Alert className="mb-6 bg-orange-50 border-orange-200">
            <AlertCircle className="h-4 w-4 text-orange-600" />
            <AlertDescription>
              <p className="font-semibold text-orange-900 mb-1">⚠️ Advance Balance Running Low</p>
              <p className="text-sm text-orange-800">
                Remaining: <strong>{formatCurrency((trip.total_advance || 0) - (trip.total_expenses || 0))}</strong>
              </p>
              <p className="text-xs text-orange-700 mt-1">
                If you need more funds, you can request an additional advance before the trip ends.
              </p>
            </AlertDescription>
          </Alert>
        )}
