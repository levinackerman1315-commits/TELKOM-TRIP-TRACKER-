...
// // export default function FinanceAreaProfile() {
...
// //           <h1 className="text-3xl font-bold">Profile Settings - Finance Area</h1>
...
// export default function FinanceRegionalProfile() {
//   const { user, updateUser } = useAuth();
//   const { toast } = useToast();
//   const navigate = useNavigate();
...
//   return (
//     <div className="container mx-auto p-6 space-y-6">
//       {/* ✅ HEADER DENGAN BACK BUTTON - UBAH UNTUK FINANCE REGIONAL */}
//       <div className="flex items-center gap-4">
//         <Button
//           variant="ghost"
...
//         </Button>
//         <div className="flex-1">
//           <h1 className="text-3xl font-bold">Profile Settings - Finance Regional</h1>
//           <p className="text-muted-foreground">Manage your account information and security</p>
//         </div>
//       </div>
...
export default function FinanceRegionalProfile() {
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ✅ IMPROVED: Extract detailed error messages from backend
