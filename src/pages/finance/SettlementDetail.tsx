...
//           </CardContent>
//           <div className="p-6">
//             <Button onClick={() => navigate('/finance-regional/dashboard')} className="w-full">
//               Back to Dashboard
//             </Button>
//           </div>
//         </Card>
...
//     <div className="min-h-screen bg-background">
//       {/* Header */}
//       <div className="bg-gradient-to-r from-red-600 to-red-700 border-b shadow-sm">
//         <div className="container mx-auto px-4 py-6">
...
//                   <p className="font-medium text-white">Settlement Completed</p>
//                   <p className="text-sm text-white/80 mt-1">
//                     This settlement has been completed successfully.
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//   // ✅ UPDATED: Use dialog instead of window.confirm
//   const handleApproveConfirm = async () => {
//     try {
//       setIsProcessing(true)
//       await tripAPI.approveSettlementRegional(Number(id), {
//         notes: 'Approved by Finance Regional - Settlement completed'
//       })
//       setShowApproveDialog(false)
//       setAlertMessage('Settlement approved and completed successfully')
...
//   // ✅ UPDATED: Use dialog instead of window.prompt
...
//           {/* Info Alerts */}
//           {canTakeAction && (
//             <div className="bg-white/10 border border-white/20 rounded-lg p-3 flex items-start gap-3">
//               <Info className="h-5 w-5 text-white mt-0.5 flex-shrink-0" />
//               <div className="text-sm text-white">
//                 <p className="font-medium">Final Review Required</p>
//                 <p className="text-white/90 mt-1">
//                   This settlement has been approved by Finance Area and is awaiting your final approval to complete.
//                 </p>
//               </div>
//             </div>
//           )}
...
//         title="Approve & Complete Settlement?"
//         message="This will mark the settlement as completed and finalize all transactions. This action cannot be undone."
//         confirmText="Yes, Approve & Complete"
//         cancelText="Cancel"
//         type="success"
...
export default function SettlementDetail() {
  ...
  <div className="text-right">
    <span className={`font-bold ${
      ...
      {formatCurrency(Math.abs((trip.total_advance || 0) - (trip.total_expenses || 0)))}
    </span>
