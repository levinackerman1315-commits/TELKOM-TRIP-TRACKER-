...
// // ===============================
// // NOMINATIM API - Autocomplete Lokasi
// // ===============================
...
//     // Filter: Prioritaskan hasil dengan 'id' di country_code
...
//         'accept-language': 'id',
//         namedetails: 1,
//         // ✅ TAMBAHAN: Prioritaskan hasil dengan detail jalan
//         featuretype: 'street,city,county,state', // Prioritaskan street level
//       },
//       headers: {
//         'User-Agent': 'TripTrackerApp/1.0 (your-email@domain.com)',
//       },
...
//     // ✅ FILTER LEBIH BAIK: Prioritaskan hasil dengan detail jalan
//     const filteredResults = response.data
//       .filter((location: any) => {
//         const address = location.address;
//         // Prioritaskan yang ada detail jalan atau kota
//         return address.country_code === 'id' && 
//                (address.road || address.city || address.town || address.village);
//       })
//       // Sort: yang punya road dulu, lalu city, dll
//       .sort((a: any, b: any) => {
//         const aScore = (a.address.road ? 10 : 0) + (a.address.city ? 5 : 0);
//         const bScore = (b.address.road ? 10 : 0) + (b.address.city ? 5 : 0);
...
// // OSRM API - Calculate Distance (tetap sama)
// export const calculateDistance = async (
//   startLat: number,
//   startLon: number,
//   endLat: number,
